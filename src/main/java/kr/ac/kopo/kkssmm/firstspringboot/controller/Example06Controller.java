...
public class Example06Controller {
    ...
    public String requestMethod2(ModelMap modelMap) {
        modelMap.addAttribute("message1","ModelMap 클래스는 Model 인터페이스에 상속받아서 구현되었다.");
...
//        modelView.setViewName("viewPageModelAndView");
        ...
        modelView.addObject("msg4", "ModelAndView 클래스는 요청 메소드의 매개변수를 통해 사용하는 것이 아니라 객체 생성을 해서 사용해야하며, 리턴 값으로 ModelAndView 객체 참조값을 사용한다");
